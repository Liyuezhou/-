	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www7.53kf.com/webCompany.php?arg=10008463&style=1&kflist=off&kf=2962993027%40qq.com%2C2482347839%40qq.com%2C2425811274%40qq.com%2C304179951%40qq.com%2C1349035911%40qq.com%2C3056215735%40qq.com%2C2193623795%40qq.com&zdkf_type=1&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fonlyonly.net%2F&keyword=http%3A%2F%2Fwww.onlyonly.net%2Fevents.html&brief=&logo=&question=&uid=3b891b2866dfd2cb51fb7e5dbc5f9567";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			// 邀请框处理 
			var acc_pop_page		 = "1";
			var acc_pop_pagenum	= 50;
			var acc_pop_total		= "1";
			var acc_pop_totalnum = 50;
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "1";
			var ivtstr						= "<div id=\'acc_title\' style=\'position:relative;overflow:hidden;background-image: url(http://www7.53kf.com/img/upload/10008463/zdyivt/zdyivt_53kf_1370169263.png);background-repeat: no-repeat;font-size: 12px;text-align:left;width: 530px;height: 250px;z-index: 0;border-style: none;font-family:&#23435;&#20307;;\'><div style=\'overflow: hidden;position:absolute;background-image: url(http://www7.53kf.com/img/ivt/new2011_02/dialog_15.png);background-repeat: no-repeat;font-size: 12px;color: #000000;width: 12px;height: 11px;left: 500px;top: 75px;z-index: 2;font-family:&#23435;&#20307;;cursor:pointer;\' onclick=\';onliner_zdfq=3;hidden_ivt();\' id=\'hz6d_53kf_invite_hid\'></div><div style=\'overflow: hidden;position:absolute;background-image: url(http://www7.53kf.com/img/ivt/new2011_02/dialog_01.png);background-repeat: no-repeat;font-size: 12px;color: #FFFFFF;font-weight: bold;width: 90px;height: 30px;left: 300px;top: 195px;z-index: 6;font-family:&#23435;&#20307;;cursor:pointer;\' onclick=\';onliner_zdfq=2;window.open(\"talk_openurl\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();\' id=\'hz6d_53kf_invite_acc\'></div><div style=\'overflow: hidden;position:absolute;background-image: url(http://www7.53kf.com/img/ivt/new2011_02/dialog_02.png);background-repeat: no-repeat;font-size: 12px;color: #000000;width: 90px;height: 30px;left: 400px;top: 195px;z-index: 7;font-family:&#23435;&#20307;;cursor:pointer;\' onclick=\';onliner_zdfq=3;hidden_ivt();\' id=\'hz6d_53kf_invite_hid\'></div><div style=\'overflow: hidden;position:absolute;background-repeat: no-repeat;line-height:120%;font-size: 12px;color: #FFFFFF;text-align:center;font-weight: bold;width: 70px;height: 20px;left: 310px;top: 205px;z-index: 8;font-family:&#23435;&#20307;;cursor:pointer;\' onclick=\';onliner_zdfq=2;window.open(\"talk_openurl\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();\' id=\'hz6d_53kf_invite_acc\'>&#21363;&#21051;&#25250;&#23450;</div><div style=\'overflow: hidden;position:absolute;background-repeat: no-repeat;line-height:120%;font-size: 12px;color: #000000;text-align:center;font-weight: bold;width: 70px;height: 20px;left: 410px;top: 205px;z-index: 9;font-family:&#23435;&#20307;;cursor:pointer;\' onclick=\';onliner_zdfq=3;hidden_ivt();\' id=\'hz6d_53kf_invite_hid\'>&#19979;&#27425;&#20877;&#35828;</div></div>";
			var is_autoyqk				= "0";
			var once_autoyqk            = 0;//邀请语开关
			var zdyivt_width			= "530px";
			var zdyivt_height		 = "250px";
			var acc_reinvite			= "1";
			var acc_reauto				= "1";
		...
		//	var acc_poptype			 = 2;
			...
			var hz6d_cname				= "&#21807;&#19968;&#35270;&#35273;&#23130;&#32433;&#25668;&#24433;&#24037;&#20316;&#23460;";
			var font_color;
			hz6d_cname = hz6d_cname.replace(/\"/g, '&quot;').replace(/\'/g, '&#039;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
			var hz6d_ivt_tpl			= "../templates/ivt/new2011_08/kf.tpl";
            ...
            if(1 == 15) {
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div class="img_logo_show" style="position: absolute;top:-10px;left:20px;z-index: 11;"><img class="icon-login" src="http://www7.53kf.com/style/chat/minichat2/img/cube-login.png?1"/></div><div id="hz6d_cname_mini_div" style="font-size:14px;font-weight: bold;position:absolute;top:0px;left:0px;width:100%;height:32px;line-height:32px;padding-left:70px;box-sizing:border-box;color:#fff;text-indent:2px;font-family:微软雅黑,arial;background:#0083FF;border-top-left-radius:10px;border-top-right-radius:10px;font-weight: normal;font-size: 12px;">' + hz6d_cname + '</div><div class="max_return" title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;top:1px;right:76px;width:39px;height:32px;background:url(http://www7.53kf.com/style/chat/minichat2/img/min.png) center no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div class="mini_maxto" title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;top:1px;right:39px;width:37px;height:32px;background:url(http://www7.53kf.com/style/chat/minichat2/img/maxto.png) center no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div class="mini_close" title="&#20851;&#38381;" style="position:absolute;top:1px;right:8px;width:31px;height:32px;background:url(http://www7.53kf.com/style/chat/minichat2/img/close.png) center no-repeat;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:400px;height:32px;background:url(http://www7.53kf.com/style/chat/minichat2/img/header_bg_dz1.png) no-repeat; border-top-right-radius: 6px;"></div><div id="iframe_company_mini_div" style="width:100%;height:415px;border:1px solid #C8C7C6;border-top:0;box-sizing: border-box;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
            ...
            if(1 == 16){
                // 定制强制对话小窗口
                var tmp_innerHTML = '<div id="img-show" style="display:inline-block;position:absolute;top:10px;left:15px;"><img src="http://www7.53kf.com/style/chat/minichat2/img/live1.jpg" style="border-radius:50%;width:45px;"></div><div id="hz6d_cname_mini_div" style="font-size:15px;overflow:hidden;position:absolute;top:20px;left:65px;width:230px;height:18px;color:#000;text-indent:2px;font-family:微软雅黑,arial"> </div><div class="mini_narrow" title="&#32553;&#23567;" mini_narrow="&#32553;&#23567;" mini_recover="&#36824;&#21407;" max_min="max" style="position:absolute;border-radius:50%;top:22px;right:38px;width:21px;height:20px;background:url(http://www7.53kf.com/style/chat/minichat2/img/minx.jpg) no-repeat; cursor:pointer;" onclick="max_min_company_mini(this);"></div><div class="mini_maxto" title="&#20999;&#25442;&#21040;&#27491;&#24120;&#31383;&#21475;" style="position:absolute;border-radius:50%;top:22px;right:70px;width:21px;height:20px;background:url(http://www7.53kf.com/style/chat/minichat2/img/double.jpg) no-repeat; cursor:pointer;" onclick="max_from_company_mini(this);"></div><div class="mini_close" title="&#20851;&#38381;" style="position:absolute;top:22px;right:10px;width:20px;height:20px;background:url(http://www7.53kf.com/style/chat/minichat2/img/close.png) no-repeat 50% 50%;cursor:pointer;" onclick="close_company_mini();"></div><div id="mini_header_bg_div" style="position:static;width:330px;height:60px;background:#56C10B;"></div><div id="iframe_company_mini_div" style="width:100%;height:100%;"><iframe id="iframe_company_mini" frameborder="0" width="100%" height="100%" ></iframe></div>';
			...
			{
				var openurl = "http://www7.53kf.com/webCompany.php?arg=10008463&style=1&kflist=off&kf=2962993027%40qq.com%2C2482347839%40qq.com%2C2425811274%40qq.com%2C304179951%40qq.com%2C1349035911%40qq.com%2C3056215735%40qq.com%2C2193623795%40qq.com&zdkf_type=1&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fonlyonly.net%2F&keyword=http%3A%2F%2Fwww.onlyonly.net%2Fevents.html&brief=&logo=&question=&uid=3b891b2866dfd2cb51fb7e5dbc5f9567&tfrom=2"+force_kf;
				try{
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    if(1 == 14) {
                        ...
                        $53("hz6d_cname_mini_div").style.background = "url('http://www7.53kf.com/style/chat/minichat2/img/1.gif') no-repeat";
                        $53("hz6d_cname_mini_div").onmouseover = function(){
                            this.style.background="url('http://www7.53kf.com/style/chat/minichat2/img/1.gif') no-repeat";
                        }
                    ...
                    if(1 == 15) {
                        ...
                        $53("div_company_mini").style.background="url('http://www7.53kf.com/style/chat/minichat2/img/cube-login.png?1') 8px center no-repeat #e8e8e8";
                    ...
                    if(1 == 16) {
                        ...
                        $53("mini_header_bg_div").style.overflow = "hidden";
                     	document.querySelector(".mini_maxto").style.display="none";
                        document.querySelector(".mini_close").style.display="none";
                        document.querySelector('.mini_narrow').style.background="url('http://www7.53kf.com/style/chat/minichat2/img/max.png') no-repeat 50% 50%";
                        return;       
                    }

                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www7.53kf.com/style/chat/minichat2/img/header_bg2_6.png')";
				}
				else
				{	
                   ...
                   if(1 == 14) {
                        ...
                        $53("hz6d_cname_mini").style.background="url(http://www7.53kf.com/style/chat/minichat2/img/m.png?1)  no-repeat"
                        ...
                        $53("hz6d_cname_mini_div").style.backgroundImage = "url('http://www7.53kf.com/style/chat/minichat2/img/1.png')";
                        $53("hz6d_cname_mini_div").style.backgroundColor="#EEF3F9";
                        $53("hz6d_cname_mini_div").onmouseover = function(){
                            this.style.background="url('http://www7.53kf.com/style/chat/minichat2/img/2.png') no-repeat #EEF3F9";
                        }
                        $53("hz6d_cname_mini_div").onmouseout = function(){
                            this.style.background="url('http://www7.53kf.com/style/chat/minichat2/img/1.png') no-repeat #EEF3F9";
                        }
                        $53("hz6d_cname_mini").onmouseover=function(){
                            this.style.background="url('http://www7.53kf.com/style/chat/minichat2/img/m.png')  no-repeat";
                        }
                        $53("hz6d_cname_mini").onmouseout=function(){
                            this.style.background="url('http://www7.53kf.com/style/chat/minichat2/img/m.png')  no-repeat";
                        }
                   ...
                   if(1 == 15) {
                        ...
                        document.querySelector(".max_return").style.background="url(http://www7.53kf.com/style/chat/minichat2/img/min.png) center no-repeat";
                   ...
                   if(1 == 16) {
						...
						t.style.backgroundImage = "url('http://www7.53kf.com/style/chat/minichat2/img/minx.jpg')";
						document.querySelector(".mini_maxto").style.display="block";
                        document.querySelector(".mini_close").style.display="block";
                        return;
                   }

                   $53("mini_header_bg_div").style.backgroundImage = "url('http://www7.53kf.com/style/chat/minichat2/img/header_bg_6.png')";
			...
			{
				if(ivt_zdfq == 'yes') {
					//document.cookie = "onliner_zdfq72008463="+onliner_zdfq;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						acpt_force_kf(force_kf);
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=6&interface_theme=3&minchat_style=1';
			...
			function close_company_mini(){	
                ...
                if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72008463="+onliner_zdfq;}
			...
			function get_ACCWindow(){
				...
				if(zdyivt==1){
					...
					ivt_height_init = "250px";
					ivt_width_init = "450px";
				}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF': 
								case 'KF': var click_open_url = 'window.open(\"http://www7.53kf.com/webCompany.php?arg=10008463&style=1&kflist=off&kf=2962993027%40qq.com%2C2482347839%40qq.com%2C2425811274%40qq.com%2C304179951%40qq.com%2C1349035911%40qq.com%2C3056215735%40qq.com%2C2193623795%40qq.com&zdkf_type=1&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fonlyonly.net%2F&keyword=http%3A%2F%2Fwww.onlyonly.net%2Fevents.html&brief=&logo=&question=&uid=3b891b2866dfd2cb51fb7e5dbc5f9567&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								click_open_url = encodeURIComponent(click_open_url);
								click_str ='onliner_zdfq=2;hz6d_is_exist(\"'+click_open_url+'\");hidden_ivt();';break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www7.53kf.com/webCompany.php?arg=10008463&style=1&kflist=off&kf=2962993027%40qq.com%2C2482347839%40qq.com%2C2425811274%40qq.com%2C304179951%40qq.com%2C1349035911%40qq.com%2C3056215735%40qq.com%2C2193623795%40qq.com&zdkf_type=1&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fonlyonly.net%2F&keyword=http%3A%2F%2Fwww.onlyonly.net%2Fevents.html&brief=&logo=&question=&uid=3b891b2866dfd2cb51fb7e5dbc5f9567&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE': click_str = 'onliner_zdfq=3;hidden_ivt();'; break;
							case 'ETEL': click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=72008463&style_id=106008678\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
							case 'QQ': 
								if(valst[1])
								{
